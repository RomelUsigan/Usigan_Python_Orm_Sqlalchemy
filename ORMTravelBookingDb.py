...
user_data = [
    User(username='rimuru1', password_hash='hashed_password1', email='rimuru@gmail.com', phone_number='09933214290', first_name='rimuru', last_name='Tempest', user_role='ADMIN'),
    User(username='diablo2', password_hash='hashed_password2', email='diablo@gmail.com', phone_number='09933214291', first_name='diablo', last_name='Noir', user_role='USERS'),
    User(username='testarrosa3', password_hash='hashed_password3', email='testarrosa@gmail.com', phone_number='09933214292', first_name='testarrosa', last_name='Blanc', user_role='ADMIN'),
    User(username='carrera4', password_hash='hashed_password4', email='carrera@gmail.com', phone_number='09933214293', first_name='carrera', last_name='Jaune', user_role='USERS'),
    User(username='ultima5', password_hash='hashed_password5', email='ultima@gmail.com', phone_number='09933214294', first_name='ultima', last_name='Violet', user_role='USERS')
]
