...
user_data = [
    User(user_id=1, user_gmail='Rimuru@gmail.com', user_password='password1', user_lastname='Tempest'),
    User(user_id=2, user_gmail='Diablo@gmail.com', user_password='password2', user_lastname='Noir'),
    User(user_id=3, user_gmail='Testarrosa@gmail.com', user_password='password3', user_lastname='Blanc'),
    User(user_id=4, user_gmail='Carrera@gmail.com', user_password='password4', user_lastname='Jaune'),
    User(user_id=5, user_gmail='Ultima@gmail.com', user_password='password5', user_lastname='Violet'),
]
...
invited_data = [
    Invited(invitation_id=1, invitation_name='Rimuru', event_id=1, attendee_type='VIP', seat_number='A1'),
    Invited(invitation_id=2, invitation_name='Diablo', event_id=2, attendee_type='Regular', seat_number='B1'),
    Invited(invitation_id=3, invitation_name='Testarrosa', event_id=3, attendee_type='VIP', seat_number='C1'),
    Invited(invitation_id=4, invitation_name='Carrera', event_id=4, attendee_type='Regular', seat_number='D1'),
    Invited(invitation_id=5, invitation_name='Ultima', event_id=5, attendee_type='VIP', seat_number='E1'),
]
