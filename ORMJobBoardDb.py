...
session.add_all([
    User(user_id=1, authentication_id=1, name='Rimuru', birthdate=datetime(1990, 1, 1, tzinfo=timezone.utc),
         skills='Python, SQL', work_experience='5 years'),
    User(user_id=2, authentication_id=2, name='Diablo', birthdate=datetime(1988, 2, 1, tzinfo=timezone.utc),
         skills='Java, NoSQL', work_experience='7 years'),
    User(user_id=3, authentication_id=3, name='Testarossa', birthdate=datetime(1992, 3, 1, tzinfo=timezone.utc),
         skills='JavaScript, React', work_experience='4 years'),
    User(user_id=4, authentication_id=4, name='Carrera', birthdate=datetime(1985, 4, 1, tzinfo=timezone.utc),
         skills='HTML, CSS', work_experience='6 years'),
    User(user_id=5, authentication_id=5, name='Ultima', birthdate=datetime(1975, 5, 1, tzinfo=timezone.utc),
         skills='C++, C#', work_experience='10 years'),

    Authentication(authentication_id=1, username='Rimuru', email='rimuru@gmail.com', password_hash='hashedpw1',
                   role='job_seeker', stock=0),
    Authentication(authentication_id=2, username='Diablo', email='diablo@gmail.com', password_hash='hashedpw2',
                   role='employer', stock=0),
    Authentication(authentication_id=3, username='Testarrosa', email='testarrosa@gmail.com', password_hash='hashedpw3',
                   role='job_seeker', stock=0),
    Authentication(authentication_id=4, username='Carrera', email='carrera@gmail.com', password_hash='hashedpw4',
                   role='employer', stock=0),
    Authentication(authentication_id=5, username='Ultima', email='ultima@gmail.com', password_hash='hashedpw5',
                   role='job_seeker', stock=0),
    ...
    Applications(application_id=1, job_seeker_id=1, job_id=1, resume='Rimuru_Resume.pdf', status='PENDING',
                 skills='Python', work_experience='5 years'),
    Applications(application_id=2, job_seeker_id=2, job_id=2, resume='Diablo_Resume.pdf', status='ACCEPTED',
                 skills='Java', work_experience='7 years'),
    Applications(application_id=3, job_seeker_id=3, job_id=3, resume='Testarrosa_Resume.pdf', status='REJECTED',
                 skills='JavaScript', work_experience='4 years'),
    Applications(application_id=4, job_seeker_id=4, job_id=4, resume='Carrera_Resume.pdf', status='PENDING',
                 skills='HTML', work_experience='6 years'),
    Applications(application_id=5, job_seeker_id=5, job_id=5, resume='Ultima_Resume.pdf', status='ACCEPTED',
